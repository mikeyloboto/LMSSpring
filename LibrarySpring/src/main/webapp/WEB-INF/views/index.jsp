		...
		<div class="col-sm-4">
			<div class="panel panel-info">
				...
				<div class="panel-body">
					...
					<p>
						<a type="button" class="btn btn-primary" href="borrower">Sign
							in</a>
					</p>
				</div>
			</div>
		...
		<div class="col-sm-4">
			<div class="panel panel-info">
				...
				<div class="panel-body">
					...
					<p>
						<a type="button" class="btn btn-primary" href="librarian">Sign
							in</a>
					</p>
				</div>
			</div>
		...
		<div class="col-sm-4">
			<div class="panel panel-danger	">
				...
				<div class="panel-body">
					...
					<p>
						<a type="button" class="btn btn-danger" href="admin">Sign
							in</a>
					</p>
				</div>
			</div>
